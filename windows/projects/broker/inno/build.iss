...
Filename: {tmp}\ReplaceTokens.vbs; Parameters: " ""{app}\broker.bat"" ""[[LOG4J]]={code:Normalize|{app}\log4j.cfg.xml}"" "; Flags: skipifdoesntexist waituntilterminated runhidden shellexec; StatusMsg: Setting configuration
Filename: {tmp}\ReplaceTokens.vbs; Parameters: " ""{app}\log4j.cfg.xml"" ""[[LOGDIR]]={code:Normalize|{code:GetUserHome}\.broker\logs\log}"" "; Flags: skipifdoesntexist waituntilterminated runhidden shellexec; StatusMsg: Setting configuration
